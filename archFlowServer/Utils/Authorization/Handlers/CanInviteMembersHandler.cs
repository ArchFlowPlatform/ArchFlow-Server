...
public class CanInviteMembersHandler : AuthorizationHandler<CanInviteMembersRequirement>
{
    private readonly AppDbContext _context;
    private readonly IHttpContextAccessor _http;

    public CanInviteMembersHandler(AppDbContext context, IHttpContextAccessor http)
    {
        _context = context;
        _http = http;
    }
    ...
    protected override async Task HandleRequirementAsync(
        ...
        CanInviteMembersRequirement requirement)
    {
